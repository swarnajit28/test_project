...
<section class="content content-custom">
      ...
      <div class="addcustomer-form">
        ...
        @endif
        <form role="form" id="customerForm" method="POST" action="{{ route('submit-lead-customer') }}" class="row" enctype="multipart/form-data">
          {{ csrf_field() }}
          <input type="hidden" value="{{$formfield['lead']}}" name="{{$formfield['lead']}}">
              ...
              <div class="viewgrp-dropdown">
                <div class="magicsearch-wrapper">
                    <select class="form-control" name="{{$formfield['is_active']}}" id="{{$formfield['is_active']}}">
                      <option selected="selected" value="1" @if($customer_data['is_active']=='1') selected @endif>Active</option>
                      <option disabled="disabled" value="0" @if($customer_data['is_active']=='0') selected @endif>Inactive</option>
                    </select>
                  </div>
              </div>
            </div>
...
<!--                    <p class="perr error" id="rNumberError">ww</p>-->
                            ...
                            <div class="viewgrp-dropdown">
                                <div class="magicsearch-wrapper">
                                    <select class="form-control" name="{{$formfield['is_outside_FA']}}" id="{{$formfield['is_outside_FA']}}">
                                        ...
                                        <option value="0" @if($customer_data['is_outside_FA']=='0') selected @endif>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
          ...
          @else          
          <input type="hidden" value="{{$id}}" name="{{$formfield['sales_person_id']}}">
          @endif
          </div>
             ...
             @if(count($contact_details)<=1)
              <div class="add-customer-reapet-part" id="contact1">                       
                ...
                <div class="form-group col-sm-6">
                  ...
                  <input type="text" name="{{$formfield['contact_person_job_role']}}[]" id="{{$formfield['contact_person_job_role']}}1" value="{{$contact_details[0]['contact_person_job_role']}}" class="form-control">
                </div>
              </div>
             @else
