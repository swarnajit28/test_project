...
<section class="content content-custom">
        ...
        @endif
      <div class="view-by">
        <form id="managecustomer" action="{{route('list-customer')}}">
        ...
        @if(Auth::user()->user_type == 'LM'||Auth::user()->user_type =='MA'||Auth::user()->user_type =='SM')
        <div class="outside_fund_hd">
          <form role="form" id="importForm" method="POST" action="{{route('import_add-customer')}}" class="row product_select" enctype="multipart/form-data">
               {{ csrf_field() }} 
          ...
          <button class="excel_donload_btn" type="button" onclick="window.location='{{route('client_download_Excel') }}'"></button>
        </div>
        @endif
      </div>
          ...
          <tbody id="load-data">
            ...
            <tr>
              <?php  $text = "";?>
                ...
                ?>
              <td>{{$customer_data['company_name']}} &nbsp; &nbsp; <span style="color:red">{{$text}} </span></td>
              ...
              <td class="text-center viewgrp-dropdown dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  @endif
                  @if(Auth::user()->user_type == 'MA')<li><a onclick="return confirm('Are you sure want to delete this customer?')" href="{{route('delete-customer',['id' => Crypt::encrypt($customer_data['id']) ])}}"><i class="fa fa-trash-o" aria-hidden="true"></i> Delete</a></li>@endif
                </ul>
              </td>
            </tr>
              @endforeach
