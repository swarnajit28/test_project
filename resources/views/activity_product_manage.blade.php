...
<section class="content content-custom">
      <div class="manage-user-page lead-list-page activity-manager-by-user">
        ...
        <div class="view-by">
          <form action="{{route('activityManagerByProduct')}}" method="POST" class="" id="listlead">
            {{ csrf_field() }}
...
//       var tdata = $('#load-data tr:last-child td#last_id').addClass('hi');
       var max = 99999999;
        ...
        var last_id=max;
         ...
         $.ajax({
             url : '{{route("loadAudiTrailByProduct")}}',
             method : "POST",
...
//             data : $('#listlead').serialize() + "&kk=1",
    ...
    document.querySelector("#downloadcsv").addEventListener("click", function () {
      ...
      export_table_to_csv(html, {{date('Ymdhis')}}+"activity_manager_by_products.csv");
      $("#deltr").remove();
      $("#acttr").show();
