    ...
    <div class="middle">
      <div class="inner">
        ...
        <div class="login-right">
         ...
         <form role="form" method="POST" action="{{ route('password.request') }}" class="row">
           {{ csrf_field() }}
          <input type="hidden" name="token" value="{{ $token }}">
              <div class="form-group col-sm-12">
                <label>Email</label>
                <input type="email" name="email" id="email" class="form-control" value="{{Crypt::decrypt($email)}}" readonly>
              </div>
              <div class="form-group col-sm-12">
