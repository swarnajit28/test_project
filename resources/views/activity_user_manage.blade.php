...
@section('title')
  <title>Activity Manager - By User</title>
...
<section class="content content-custom">
      <div class="manage-user-page lead-list-page activity-manager-by-user">
        
        <div class="view-by">
          <form action="{{route('activity-manager-by-user')}}" method="POST" class="" id="listlead">
            {{ csrf_field() }}
              ...
              <div class="viewgrp-dropdown">
                <div class="magicsearch-wrapper">
                  <select class="form-control" name="user">
                    ...
                    <option value="{{$user['id']}}" @if($postArr['user']==$user['id']) selected="" @endif>{{$user['display_name']}}</option>
                    @endforeach
                    @endif
                  </select>
                </div>
...
//        var last_id = $("#last_id").html();
        //var last_id = $('#loadtable tr:last').attr('id');
        var max = 99999999;
...
//  function gotomodal(lead_id,acttype,compname,loan,act_mode,act_time,act_note)
//  {
//    if(acttype == 2){
//      html = '<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal"><i class="close-icon"></i></button><h4 class="modal-title">View Activity Details</h4></div><div class="modal-body"><div class="row"><div class="col-sm-4"><p><span>Lead No.</span>L00'+lead_id+'</p></div><div class="col-sm-4"><p><span>Customers Name</span>'+compname+'</p></div><div class="col-sm-4"><p><span>Status</span>'+loan+'</p></div><div class="col-sm-4"><p><span>Activity Type</span>Manual</p></div><div class="col-sm-4"><p><span>Activity Mode Type</span>'+act_mode+'</p></div><div class="col-sm-4"><p><span>Date Time</span>'+act_time+'</p></div><div class="clearfix"></div><div class="col-sm-12"><p><span>Activity Notes</span>'+act_note+'</p></div></div></div>/div></div>';
//    }
//    else if(acttype == 1){
//      html = '<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal"><i class="close-icon"></i></button><h4 class="modal-title">View Activity Details</h4></div><div class="modal-body"><div class="row"><div class="col-sm-4"><p><span>Lead No.</span>L00'+lead_id+'</p></div><div class="col-sm-4"><p><span>Customers Name</span>'+compname+'</p></div><div class="col-sm-4"><p><span>Status</span>'+loan+'</p></div><div class="col-sm-4"><p><span>Activity Type</span>Automatic</p></div><div class="col-sm-4"><p><span>Activity Mode Type</span>----</p></div><div class="col-sm-4"><p><span>Date Time</span>'+act_time+'</p></div><div class="clearfix"></div></div></div>/div></div>';
//    }
...
//  }
    ...
    document.querySelector("#downloadcsv").addEventListener("click", function () {
      ...
      export_table_to_csv(html, {{date('Ymdhis')}}+"activity_manager_by_users.csv");
      $("#deltr").remove();
      $("#acttr").show();
